...
export const POSTS: Post[] = [
	{
		...
		fullDescription: 'Сегодня мы готовы поделиться с вами обзором нового суперкара от известного производителя. Стильный дизайн, мощный двигатель и передовые технологии - все это делает эту машину по-настоящему уникальной. Готовы ли вы отправиться в захватывающее путешествие на этом автомобиле?',
		userInfoId: 1,
	...
	},
	{
		...
		fullDescription: 'Шоколад – волшебное зелье, растворит любые трудности и принесет мгновения настоящего блаженства. Как только он плавится на языке, весь мир кажется ярче и краше. Шоколад – это не просто угощение, это счастья на каждый день. Пусть каждый день наполнится ароматами и вкусами шоколада',
		userInfoId: 0,
	...
	},
	{
		...
		fullDescription: 'Летние платья будут главным трендом следующего сезона! От легких платьев-рубашек до ярких сарафанов. Невероятное разнообразие стилей и фасонов. Оттенки пудры, цвета солнца и сочные оттенки фруктов. Не бойтесь экспериментировать и создавать свой неповторимый образ!',
		userInfoId: 0,
